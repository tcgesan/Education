...
function phrase() {
    ...
    setTimeout(function() {
      window.location.href = '../HTMLS/phrase.html'; // Redirect after 3 seconds
    },150); // 3000 milliseconds = 3 seconds
  }
...
function clause() {
    ...
    setTimeout(function() {
      window.location.href = '../HTMLS/clause.html'; // Redirect after 3 seconds
    },150); // 3000 milliseconds = 3 seconds
  }
...
function voicee() {
    ...
    setTimeout(function() {
      window.location.href = '../HTMLS/voicee.html'; // Redirect after 3 seconds
    },150); // 3000 milliseconds = 3 seconds
  }
...
function vocab() {
    ...
    setTimeout(function() {
      window.location.href = '../HTMLS/vocab.html'; // Redirect after 3 seconds
    },150); // 3000 milliseconds = 3 seconds
  }
